...
import cn.zcbdqn.commoninventory.MyAdapter;
import cn.zcbdqn.commoninventory.R;
import cn.zcbdqn.commoninventory.Sub3TabActivity;
import cn.zcbdqn.commoninventory.Sub4TabActivity;
...
public class InStockActivity2 extends TabActivity {
...
//                    Comm.uhf6.UHF6handler = uhfhandler;
				...
				if (!android.text.TextUtils.isEmpty(strMsg)) {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		tabHost.setup();
		TabHost.TabSpec tp = tabHost.newTabSpec("tab1").setIndicator("盘点")
		...
		button_read.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				try {
					...
					Toast.makeText(InStockActivity2.this,
			...
			public void onClick(View arg0) {
				...
				if (Comm.setParameters()) {
					if (isQuick) {//是否快速模式 true为是 false为否
						isQuick = false;
						button_set.setText("实时");
						Toast.makeText(InStockActivity2.this, "RealTime mode set success!", Toast.LENGTH_SHORT)
								.show();
					} else {
						isQuick = true;
						button_set.setText("快速");
						Toast.makeText(InStockActivity2.this, "Quick mode set success!", Toast.LENGTH_SHORT)
								.show();
					}
				} else
					Toast.makeText(InStockActivity2.this, "set false!", Toast.LENGTH_SHORT)
							.show();
			}
		});
		...
		cb_readtid.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener(){
			...
			public void onCheckedChanged(CompoundButton buttonView,
				...
				if (Comm.SetInventoryTid(isChecked))
					Toast.makeText(InStockActivity2.this, "set success!", Toast.LENGTH_SHORT)
							.show();
				else
					Toast.makeText(InStockActivity2.this, "set fail!", Toast.LENGTH_SHORT)
							.show();
